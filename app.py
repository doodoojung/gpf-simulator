...
# 2.1.1 ยอดเงิน กบข.
gpf_current_balance = st.sidebar.number_input("💰 ยอดเงิน กบข. ปัจจุบัน", min_value=0.0, value=0.0, step=1000.0)
# เพิ่มบรรทัดนี้เพื่อโชว์ตัวเลขแบบมีลูกน้ำสวยๆ ด้านล่างกล่อง
st.sidebar.markdown(f"<div style='text-align: right; color: #0066cc; font-size: 18px; font-weight: bold;'>{gpf_current_balance:,.2f} บาท</div>", unsafe_allow_html=True)

# 2.1.2 เงินเดือน
current_salary = st.sidebar.number_input("💵 เงินเดือนปัจจุบัน", min_value=0.0, value=0.0, step=1000.0)
st.sidebar.markdown(f"<div style='text-align: right; color: #0066cc; font-size: 18px; font-weight: bold;'>{current_salary:,.2f} บาท</div>", unsafe_allow_html=True)
...
st.sidebar.markdown(f"<div style='text-align: right; color: #0066cc; font-size: 18px; font-weight: bold;'>{vayupak_amount:,.2f} บาท</div>", unsafe_allow_html=True)
