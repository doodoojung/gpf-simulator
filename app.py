...
gpf_current_balance = st.sidebar.number_input("💰 ยอดเงิน กบข. ปัจจุบัน (บาท)", min_value=0.0, value=0.0, step=1000.0)
current_salary = st.sidebar.number_input("💵 เงินเดือนปัจจุบัน (บาท)", min_value=0.0, value=0.0, step=1000.0)
